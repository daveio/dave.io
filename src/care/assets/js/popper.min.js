        ...
        u = {
          ...
          setOptions: function (r) {
            ...
            l(),
              ...
              (f.scrollParents = { reference: n(e) ? w(e) : e.contextElement ? w(e.contextElement) : [], popper: w(t) })
            var s,
              p,
              d = (function (e) {
                var t = q(e)
    ...
    if (u) {
      ...
      if (
        ...
        (M = A),
          ...
          (b *= p ? 1 : -1)
      if (i === P || ((i === D || i === A) && a === B))
        (j = L), (y -= (h && W === k && k.visualViewport ? k.visualViewport.width : W[T]) - o.width), (y *= p ? 1 : -1)
    }
    var R,
