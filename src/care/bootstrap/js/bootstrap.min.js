...
!(function (t, e) {
  ...
  const i = e(t),
    ...
    o = 'transitionend',
    r = (t) => (
      t && window.CSS && window.CSS.escape && (t = t.replace(/#([^\s"#']+)/g, (t, e) => `#${CSS.escape(e)}`)), t
    ),
    a = (t) => {
    ...
    c = (t) =>
      l(t) ? (t.jquery ? t[0] : t) : 'string' == typeof t && t.length > 0 ? document.querySelector(r(t)) : null,
    h = (t) => {
        ...
        ? (function (t, e, i) {
            return function s(n) {
              ...
              for (let { target: r } = n; r && r !== this; r = r.parentNode)
                for (const a of o)
                  if (a === r) return F(n, { delegateTarget: r }), s.oneOff && j.off(t, n.type, e, i), i.apply(r, [n])
            }
          })(t, i, r)
        : (function (t, e) {
            return function i(s) {
    ...
    _addEventListeners() {
      this._config.keyboard && j.on(this._element, mt, (t) => this._keydown(t)),
        'hover' === this._config.pause &&
          (j.on(this._element, pt, () => this.pause()), j.on(this._element, bt, () => this._maybeEnableCycle())),
  ...
  class fe extends W {
    ...
    static dataApiKeydownHandler(t) {
      ...
      const n = this.matches(ne)
          ? this
          : K.prev(this, ne)[0] || K.next(this, ne)[0] || K.findOne(ne, t.delegateTarget.parentNode),
  ...
  const Xi = '.bs.tab',
    ...
    _s = `.nav-link${ds}, .list-group-item${ds}, [role="tab"]${ds}, ${us}`,
    gs = `.${ls}[data-bs-toggle="tab"], .${ls}[data-bs-toggle="pill"], .${ls}[data-bs-toggle="list"]`
  class fs extends W {
    constructor(t) {
      super(t),
  ...
  class Os extends W {
    ...
    show() {
      j.trigger(this._element, Es).defaultPrevented ||
        (this._clearTimeout(),
        this._config.animation && this._element.classList.add('fade'),
        this._element.classList.remove(Ts),
        g(this._element),
        this._element.classList.add(ks, $s),
        this._queueCallback(
          () => {
    ...
    hide() {
      this.isShown() &&
        (j.trigger(this._element, ws).defaultPrevented ||
    ...
    _setListeners() {
      j.on(this._element, ps, (t) => this._onInteraction(t, !0)),
        j.on(this._element, bs, (t) => this._onInteraction(t, !1)),
        j.on(this._element, vs, (t) => this._onInteraction(t, !0)),
        j.on(this._element, ys, (t) => this._onInteraction(t, !1))
    }
    _clearTimeout() {
